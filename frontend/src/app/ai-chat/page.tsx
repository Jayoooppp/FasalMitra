...
export default function AIChatPage() {
    ...
    return (
        <div className="app">
            <TopBar title="FasalMitra AI" subtitle="Powered by Claude · Hindi · Marathi · English" backHref="/dashboard" icon="🎙️" />
            ...
            <div className="chat-bar">
                <input className="chat-inp" value={input} onChange={e => setInput(e.target.value)} placeholder="Type your question…" onKeyDown={e => e.key === 'Enter' && sendMessage(input)} />
